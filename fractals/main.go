...
// Creates an animated GIF with frames displaying Julia sets for the process
//   z -> z^2 + c
...
// Functionally equivalent to julia above, but frames are generated by goroutines.
...
// Worker goroutine to generate a frame.
...
// Iterates Newton's method to find a root of p(x) = x^4 - 1 starting with initial guess = z.
...
// Iterates the process z -> z^2 + .7885 e^i*alpha starting at z until either 400 iterations have
